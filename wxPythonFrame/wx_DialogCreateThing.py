...
###########################################################################
## Class DialogCreateThing
###########################################################################

class DialogCreateThing(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText15 = wx.StaticText(self.m_panel14, wx.ID_ANY, u"事件", wx.DefaultPosition, wx.DefaultSize, 0)
    ...
    def addThing(self, event):
        ...
        self.db.insertNormalThing(thingTime, thingName)
        # 更新 listbox
        self.setbool = 1
        self.Destroy()
