...
###########################################################################
## Class DialogPWFailed
###########################################################################

class DialogPWFailed(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText6 = wx.StaticText(self.m_panel11, wx.ID_ANY, u"密码错误", wx.DefaultPosition, wx.DefaultSize, 0)
